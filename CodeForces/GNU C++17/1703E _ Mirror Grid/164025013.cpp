...
void solve()
{
    ...
    ll x1=0,y1=0,x2=0,y2=n-1,x3=n-1,y3=0,x4=n-1,y4=n-1;
    // y1++ //y2-- //y3++ // y4-- y1==y2
    ll ntm=n/2;
    x=0,y=n-1;
    ll layer=0;
...
/*        if(y1==y2)
        {
          ...
          if(one>zero){
            if(a[x1][y1]==0){a[x1][y1]==1,ans++;}
            if(a[x3][y3]==0){a[x3][y3]=1,ans++;}
            if(a[y1][x1]==0){a[y1][x1]=1,ans++;}
            if(a[y3][x3]==0){a[y3][x3]=1,ans++; }   
          } 
          else{
            if(a[x1][y1]==1){a[x1][y1]==0,ans++;}
            if(a[x3][y3]==1){a[x3][y3]=0,ans++;}
            if(a[y1][x1]==1){a[y1][x1]=0,ans++;}
            if(a[y3][x3]==1){a[y3][x3]=0,ans++;}             
          }
        }
        else
        {*/
          ...
          if(one>zero){
            if(a[x1][y1]==0){a[x1][y1]=1,ans++;}
            if(a[x3][y3]==0){a[x3][y3]=1,ans++;}
            if(a[x2][y2]==0){a[x2][y2]=1,ans++;}
            if(a[x4][y4]==0){a[x4][y4]=1,ans++;}
          } 
          else{
            if(a[x1][y1]==1){a[x1][y1]=0;ans++;}
            if(a[x3][y3]==1){a[x3][y3]=0,ans++;}
            if(a[x2][y2]==1){a[x2][y2]=0,ans++;}
            if(a[x4][y4]==1){a[x4][y4]=0,ans++; }            
          }
        //}
          y1++;x2++;x3--;y4--;
      ...
      x++,y--;
      //x3--,x4--;x1++,x2++;
      //y1=0,y2=n-1,y3=0,y4=n-1;
      //cout<<x1<<" "<<x2<<" "<<x3<<sp<<x4<<endl;
      //cout<<y1<<" "<<y2<<" "<<y3<<sp<<y4<<endl;
    }
    if(n%2){
      x=n/2;
      if(a[x][x]==1)totalOne--;
    ...
    cout<<min({totalzero,totalOne,ans})<<endl;
}
