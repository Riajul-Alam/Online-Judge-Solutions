...
#define eps 1e-10
#define INF 1e18
ll Compute(vector<ll>a,ll mxel)
{
    ll odd=0,even=0,x,y,n=sz(a),ans=0;
    for(int i=0;i<n;i++)
    {
      x=mxel-a[i];
      even+=(x/2);
...
void solve()
{
    ll n,m,i,j,k,x,y,z,sum=0,c1=0,c2=0,ans=0,ans1=0;
    cin>>n;
    vector<ll>a(n);
    for(int i=0;i<n;i++)
    {
