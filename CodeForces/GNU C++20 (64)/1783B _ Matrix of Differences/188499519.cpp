...
void solve()
{
    ...
    ll flag=1;
    while(total<=(n*n)){
      ll tm1,tm2;tm1=up,tm2=down;
      for(int i=0;i<n;i++){
        if(valid(n,n,i,tm1) && a[i][tm1]==0){
          total++;
          if(flag==0){a[i][tm1]=mx;mx--;tm1++;}
          else{
            a[i][tm1]=mn;mn++;tm1++;
          }
        }
      ...
      for(int i=0;i<n;i++){
        if(valid(n,n,tm2,i)&& a[tm2][i]==0){
          total++;
          if(flag==0){a[tm2][i]=mx;mx--;tm2++;}
          else{
            a[tm2][i]=mn;mn++;tm2++;
          }
        }
